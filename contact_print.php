...
$COL_META['id']['value']            = function ($r) { return (int)$r['contact_id']; };
$COL_META['client']['value']        = function ($r) { return (string)($r['cli_name'] ?? ''); };
$COL_META['datetime']['value']      = function ($r) { $raw = (string)($r['datetime'] ?? ''); return $raw !== '' ? date('d.m.Y H:i', strtotime($raw)) : ''; };
$COL_META['impotant_flag']['value'] = function ($r) { return (string)($r['impotant_flag'] ?? '0') === '1' ? 'Экспорт в Excel' : 'Экспорт в Excel'; };
...
$PRINT_WIDTHS = contact_columns_widths_print();
...
<body>
  ...
  <div class="print-page">
    <div class="print-page-header">
      <div class="print-page-title">Контакты<?= $onlyPage ? 'Экспорт в Excel' . (int)$pageNum : '' ?></div>
