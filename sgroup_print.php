...
$COL_META['id']['value']    = function ($r) { return (int)$r['sgroup_id']; };
$COL_META['name']['value']  = function ($r) { return (string)($r['name'] ?? ''); };
$COL_META['group']['value'] = function ($r) { return (string)($r['group_name'] ?? ''); };
$COL_META['note']['value']  = function ($r) { return (string)($r['note'] ?? ''); };
$PRINT_WIDTHS = sgroup_columns_widths_print();
...
$printTitle = $sgroupIsService ? 'Экспорт в Excel' : 'Экспорт в Excel';
...
<head>
  ...
  <title><?= hprint($printTitle) ?> — Печать</title>
  <style>
    body {
...
<body>
  ...
  <div class="print-page">
    <div class="print-page-header">
      <div class="print-page-title"><?= hprint($printTitle) ?><?= $onlyPage ? ' &mdash; страница ' . (int)$pageNum : '' ?></div>
