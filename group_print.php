...
$PRINT_WIDTHS = group_columns_widths_print();
...
<head>
  ...
  <title>Группы товаров — Печать</title>
  <style>
    body {
...
<body>
  ...
  <div class="print-page">
    <div class="print-page-header">
      <div class="print-page-title">Группы товаров<?= $onlyPage ? ' &mdash; страница ' . (int)$pageNum : '' ?></div>
