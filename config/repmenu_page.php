...
$repmenuPageConfig = [
    ...
    'key_expr'             => 'm.rp_id',
    'col_filters' => [],
    'select_sql'   => "SELECT m.rp_id, m.number, m.gr_id, m.name, m.fname, m.quant, m.HIDE_FLAG, m.note, rg.name AS group_name FROM repmenu m LEFT JOIN repgroup rg ON rg.gr_id = m.gr_id",
