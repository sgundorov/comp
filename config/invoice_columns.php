...
function invoice_columns_defaults() {
    return [
        ['name' => 'number',        'label' => '№',              'sort_expr' => 'i.number',       'search' => true,  'filter' => false, 'export' => true, 'param' => null],
        ...
        ['name' => 'sum_plat',      'label' => 'Оплачено',        'sort_expr' => 'i.sum_plat',     'search' => true,  'filter' => false, 'export' => true, 'param' => null, 'readonly' => true],
...
function invoice_columns_widths_export() {
    return ['number'=>80, 'date'=>90, 'client'=>200, 'state'=>100, 'store'=>150, 'discount'=>80, 'sum'=>100, 'sum_plat'=>100, 'sotr'=>150, 'pos'=>60, 'note'=>200];
}

function invoice_columns_widths_print() {
    return ['number'=>'80px', 'date'=>'90px', 'client'=>'', 'state'=>'100px', 'store'=>'105px', 'discount'=>'80px', 'sum'=>'105px', 'sum_plat'=>'105px', 'sotr'=>'105px', 'pos'=>'60px', 'note'=>''];
}
