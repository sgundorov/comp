...
$COL_META['id']['value']      = function ($r) { return (int)$r['store_id']; };
...
$PRINT_WIDTHS = store_columns_widths_print();
...
<body>
  ...
  <div class="print-page">
    <div class="print-page-header">
      <div class="print-page-title">Участки<?= $onlyPage ? ' &mdash; страница ' . (int)$pageNum : '' ?></div>
