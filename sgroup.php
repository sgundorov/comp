...
?>
  ...
  <script>
    ...
    (function () {
      SelectionToolbar.initTableSelection('sgroup.php', document.querySelector('.toolbar').getAttribute('data-search') || '');
      ...
      SelectionToolbar.init({
        ...
        getExportUrl: function () {
          ...
          return 'sgroup_export.php?format=csv&selected=1&' + sp.toString();
        },
        getPrintUrl: function () {
          var sp = new URLSearchParams(location.search);
          ['action', 'page'].forEach(function (k) { sp.delete(k); });
          return 'sgroup_print.php?selected=1&' + sp.toString();
        }
      });
