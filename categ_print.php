...
$COL_META['id']['value']           = function ($r) { return (int)$r['categ_id']; };
$COL_META['categ']['value']         = function ($r) { return (string)($r['categ'] ?? ''); };
$COL_META['noquant_flag']['value']  = function ($r) { return !empty($r['noquant_flag']) ? 'Экспорт в Excel' : 'Экспорт в Excel'; };
$COL_META['service_flag']['value']  = function ($r) { return !empty($r['service_flag']) ? 'Экспорт в Excel' : 'Экспорт в Excel'; };
$COL_META['note']['value']          = function ($r) { return (string)($r['note'] ?? ''); };
$PRINT_WIDTHS = categ_columns_widths_print();
...
<head>
  ...
  <title>Категории товаров — Печать</title>
  <style>
    body {
...
<body>
  ...
  <div class="print-page">
    <div class="print-page-header">
      <div class="print-page-title">Категории товаров<?= $onlyPage ? ' &mdash; страница ' . (int)$pageNum : '' ?></div>
