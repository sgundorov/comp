  ...
  <script>
    ...
    (function () {
      ...
      checkAll.addEventListener('change', function () {
        location.href = 'store.php?action=toggleSelectAll' + (search ? '&q=' + encodeURIComponent(search) : '');
      });
      ...
      rowChecks.forEach(cb => cb.addEventListener('change', function () {
        ...
        const to  = cb.checked;
        cb.disabled = true;
        fetch('store.php?action=toggleSelect', {
          method: 'POST',
      ...
      SelectionToolbar.init({
        ...
        getExportUrl: function () {
          ...
          return 'store_export.php?format=csv&all=1';
        },
        getPrintUrl: function () {
          if (markedSet.size === 0) return null;
          return 'store_print.php?all=1';
        }
      });
