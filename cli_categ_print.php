...
$PRINT_WIDTHS = cli_categ_columns_widths_print();
...
$pageCount = 0;
if ($onlyPage) {
    $countSql = "SELECT COUNT(*) AS c FROM cli_categ cc $where";
...
<head>
  <meta charset="UTF-8" />
  <title>Категории контрагентов — Печать</title>
  <style>
    body {
...
<body>
  ...
  <div class="print-page">
    <div class="print-page-header">
      <div class="print-page-title">Категории контрагентов<?= $onlyPage ? ' &mdash; страница ' . (int)$pageNum : '' ?></div>
