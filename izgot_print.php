...
$COL_META['id']['value']      = function ($r) { return (int)$r['izgot_id']; };
$COL_META['izgot']['value']   = function ($r) { return (string)($r['izgot'] ?? ''); };
$COL_META['country']['value'] = function ($r) { return (string)($r['country'] ?? ''); };
$COL_META['note']['value']    = function ($r) { return (string)($r['note'] ?? ''); };
$PRINT_WIDTHS = izgot_columns_widths_print();
...
<head>
  <meta charset="UTF-8" />
  <title>Производители — Печать</title>
  <style>
    body {
...
<body>
  ...
  <div class="print-page">
    <div class="print-page-header">
      <div class="print-page-title">Производители<?= $onlyPage ? ' &mdash; страница ' . (int)$pageNum : '' ?></div>
