...
<body>
  ...
  <div class="print-page">
    <div class="print-page-header">
      <div class="print-page-title">Страны<?= $onlyPage ? ' &mdash; страница ' . (int)$pageNum : '' ?></div>
