...
$COL_META['id']['value']      = function ($r) { return (int)$r['zat_id']; };
$COL_META['name']['value']    = function ($r) { return (string)($r['name'] ?? ''); };
$COL_META['out_flag']['value'] = function ($r) { return (int)($r['out_flag'] ?? 0) ? 'Экспорт в Excel' : 'Экспорт в Excel'; };
$COL_META['note']['value']    = function ($r) { return (string)($r['note'] ?? ''); };
$PRINT_WIDTHS = zat_columns_widths_print();
...
<head>
  <meta charset="UTF-8" />
  <title>Виды операций с деньгами — Печать</title>
  <style>
    body {
...
<body>
  ...
  <div class="print-page">
    <div class="print-page-header">
      <div class="print-page-title">Виды операций с деньгами<?= $onlyPage ? ' &mdash; страница ' . (int)$pageNum : '' ?></div>
