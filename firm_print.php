...
$PRINT_WIDTHS = firm_columns_widths_print();
...
$pageCount = 0;
if ($onlyPage) {
    $countSql = "SELECT COUNT(*) AS c FROM firm f LEFT JOIN city c ON c.city_id = f.city_id $where";
...
<body>
  ...
  <div class="print-page">
    <div class="print-page-header">
      <div class="print-page-title">Фирмы<?= $onlyPage ? ' &mdash; страница ' . (int)$pageNum : '' ?></div>
