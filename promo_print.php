...
$COL_META['promo_id']['value'] = function ($r) { return (int)$r['promo_id']; };
$COL_META['promo']['value']    = function ($r) { return (string)($r['promo'] ?? ''); };
$COL_META['bdate']['value']    = function ($r) { return (string)($r['bdate'] ?? ''); };
$COL_META['edate']['value']    = function ($r) { return (string)($r['edate'] ?? ''); };
$COL_META['count']['value']    = function ($r) { return (string)($r['count'] ?? ''); };
$COL_META['procent']['value']  = function ($r) { return (string)($r['procent'] ?? ''); };
$COL_META['note']['value']     = function ($r) { return (string)($r['note'] ?? ''); };
$PRINT_WIDTHS = promo_columns_widths_print();
...
<head>
  <meta charset="UTF-8" />
  <title>Источники рекламы — Печать</title>
  <style>
    body {
...
<body>
  ...
  <div class="print-page">
    <div class="print-page-header">
      <div class="print-page-title">Источники рекламы<?= $onlyPage ? ' &mdash; страница ' . (int)$pageNum : '' ?></div>
