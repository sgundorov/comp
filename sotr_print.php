...
$COL_META['id']['value']         = function ($r) { return (int)$r['sotr_id']; };
...
$COL_META['second_name']['value']= function ($r) { return (string)($r['second_name'] ?? ''); };
$COL_META['role']['value']       = function ($r) { return (string)($r['role_name'] ?? ''); };
$COL_META['sphone']['value']     = function ($r) { return (string)($r['sphone'] ?? ''); };
$COL_META['address']['value']    = function ($r) { return (string)($r['address'] ?? ''); };
$COL_META['title']['value']      = function ($r) { return (string)($r['title'] ?? ''); };
$COL_META['user_status']['value']= function ($r) { return ((string)($r['user_status'] ?? '0') === '1') ? 'Да' : 'Нет'; };
$COL_META['note']['value']       = function ($r) { return (string)($r['note'] ?? ''); };
$PRINT_WIDTHS = sotr_columns_widths_print();
...
<body>
  ...
  <div class="print-page">
    <div class="print-page-header">
      <div class="print-page-title">Сотрудники<?= $onlyPage ? ' &mdash; страница ' . (int)$pageNum : '' ?></div>
