...
$COL_META['id']['value']     = function ($r) { return (int)$r['object_id']; };
$COL_META['object']['value'] = function ($r) { return (string)($r['object'] ?? ''); };
$COL_META['name']['value']   = function ($r) { return (string)($r['name'] ?? ''); };
$COL_META['type']['value']   = function ($r) { return (string)($r['type'] ?? ''); };
$COL_META['note']['value']   = function ($r) { return (string)($r['note'] ?? ''); };
$PRINT_WIDTHS = object_columns_widths_print();
...
<head>
  <meta charset="UTF-8" />
  <title>Объекты доступа — Печать</title>
  <style>
    body {
...
<body>
  ...
  <div class="print-page">
    <div class="print-page-header">
      <div class="print-page-title">Объекты доступа<?= $onlyPage ? ' &mdash; страница ' . (int)$pageNum : '' ?></div>
